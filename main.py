...
def send_bale(resault):
    token = os.environ.get("bale_token")
    user_id = int(os.environ.get("user_id"))
    r = requests.post(f"https://tapi.bale.ai/bot{token}/sendMessage",params={"chat_id":user_id,"text":resault})
